...
public class StylishFAB extends FloatingActionMenu implements View.OnTouchListener {
    ...
    public StylishFAB(Context context) {
        super(context);
        init();
    }

    public StylishFAB(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public StylishFAB(Context context, AttributeSet attrs, int defStyleAttr) {
